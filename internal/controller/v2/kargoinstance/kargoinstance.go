...
func resolveKargoSecrets(ctx context.Context, kube client.Client, mg *v1alpha2.KargoInstance) (resolvedKargoSecrets, error) {
	ns := mg.GetNamespace()
...
func resolveKargoRepoCreds(ctx context.Context, kube client.Client, ns string, refs []v1alpha2.KargoRepoCredentialSecretRef) ([]kargoResolvedRepoCred, error) {
...
func setSecretHash(mg *v1alpha2.KargoInstance, h string) {
	mg.Status.AtProvider.SecretHash = h
}

func getSecretHash(mg *v1alpha2.KargoInstance) string {
...
func setKargoConfigMapHash(mg *v1alpha2.KargoInstance, h string) {
	mg.Status.AtProvider.KargoConfigMapHash = h
}

func getKargoConfigMapHash(mg *v1alpha2.KargoInstance) string {
...
func specToPB(in v1alpha2.KargoInstanceParameters, resolvedDex map[string]string) (*structpb.Struct, error) {
	...
	if len(resolvedDex) > 0 {
		...
		wire.Spec.OidcConfig.DexConfigSecret = glue.DexConfigSecretResolvedToAPI(resolvedDex)
	}
