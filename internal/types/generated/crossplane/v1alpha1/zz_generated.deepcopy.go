...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IncidentSubscription) DeepCopyInto(out *IncidentSubscription) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IncidentSubscription.
func (in *IncidentSubscription) DeepCopy() *IncidentSubscription {
	if in == nil {
		return nil
	}
	out := new(IncidentSubscription)
	in.DeepCopyInto(out)
	return out
}
...
func (in *IncidentsConfig) DeepCopyInto(out *IncidentsConfig) {
	*out = *in
	if in.DegradedArgocdApps != nil {
		in, out := &in.DegradedArgocdApps, &out.DegradedArgocdApps
		*out = new(bool)
		**out = **in
	}
	if in.DegradedK8SNamespaces != nil {
		in, out := &in.DegradedK8SNamespaces, &out.DegradedK8SNamespaces
		*out = new(bool)
		**out = **in
	}
	if in.Subscriptions != nil {
		in, out := &in.Subscriptions, &out.Subscriptions
		*out = make([]*IncidentSubscription, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(IncidentSubscription)
